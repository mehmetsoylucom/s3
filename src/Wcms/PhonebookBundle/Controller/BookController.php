...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $books = $em->getRepository('WcmsPhonebookBundle:Book')->findAll();
    ...
    {
        $book = new Book();
        $form = $this->createForm('Wcms\PhonebookBundle\Form\BookType', $book);
    ...
    {
        $deleteForm = $this->createDeleteForm($book);
        $editForm = $this->createForm('Wcms\PhonebookBundle\Form\BookType', $book);
